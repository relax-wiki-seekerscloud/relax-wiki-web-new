...
const routes: Routes = [
  {path: '', component: HotelManagementComponent},
  {
    ...
    loadChildren: () => import('./modules/hotel-owner-profile/hotel-owner-profile.module').then(m => m.HotelOwnerProfileModule)
  },
  {
    path: 'hotel-default',
    component: HotelDefaultComponent,
    resolve: {
      data: HotelSearchService
    },
  },
  {
